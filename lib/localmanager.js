...
Cu.import("resource://gre/modules/FileUtils.jsm");
  ...
  pub.init = function(){
    ...
    var statement = pub.localRecord.createStatement("CREATE TABLE IF NOT EXISTS " + pub.RECORDTABLENAME + "(url_pattern STRING DEFAULT '', input STRING DEFAULT '', replacement STRING DEFAULT '')");
    try {
